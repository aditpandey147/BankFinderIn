// Mobile menu toggle
    ...
    mobileMenuBtn?.addEventListener("click", () => navLinks.classList.toggle("hidden"));
    ...
    const banks = [
      ...
      },
      {
        ...
        address: "195, Barrackpore - Barasat Rd, P.O-N.C Pukur, Kolkata, Barrackpore, West Bengal 700122",
        ifsc: "CNRB0019774",
        phone: "18001030",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        name: "Bank of India",
        branch: "Barrackpore",
        address: "199 Barasat Road Po Nona Chandanpurkurbarrackpore Dist North 24 Parganas",
        ifsc: "BKID0004378",
        phone: "25922470",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        ...
        address: "Station, Main Rd E, P O, Chandra Pally, New Barrakpur, West Bengal 700131",
        ifsc: "SBIN0006809",
        phone: "18001234",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        ...
        address: "Colony More Barasat 15 Sarojinipally Barrackpore Road Helabattala Nabapally, Barasat, West Bengal 700126",
        ifsc: "SBIN0010090",
        phone: "18001234",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        ...
        address: "91, Barasat Road, 24 Paraganas, North, Nona Chandanpukur, P.O, West Bengal 700122",
        ifsc: "SBIN0014530",
        phone: "18001234",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        name: "State bank of india",
        branch: "Talpukur",
        address: "7, K N Mukherjee Road Talpukur Barrackpore North 24 Parganas 24 Paraganas, West Bengal 700123",
        ifsc: "SBIN0016769",
        phone: "18001234",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        name: "State bank of india",
        branch: "Lalkuthi",
        address: "67a, Ghoshpara Road, Lalkuthi Barrachpore, North 24 Paraganas 24 Paraganas, West Bengal 700120",
        ifsc: "SBIN0017371",
        phone: "18001234",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        ...
        address: "Bldg No T-6-1 To T-6-4 Shopping Complex, Barrackpore Cantonment, kolkata, West Bengal-700120",
        ifsc: "SBIN0061644",
        phone: "+919674058999",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        name: "Axis Bank",
        branch: "Barrackpore",
        address: "Disha Eye Hospital & Research Centre 99/1, S.n. Banerjee Road, Barrackpore, West Bengal 700120",
        ifsc: "UTIB0000436",
        phone: "18605005555",
        hours: { mon_fri: "12:00 AM - 12:00 PM", sat: "12:00 AM - 12:00 PM", sun: "Closed" },
      ...
      },
      {
        name: "Axis Bank",
        branch: "New Barrackpore",
        address: "Basudha Apartment, 33 & 35 A.P.C. Road, New Barrackpore, PS Ghola, Dist. North 24 Parganas, West Bengal, Pin 700131",
        ifsc: "UTIB0001656",
        phone: "18605005555",
        hours: { mon_fri: "09:30 AM - 3:30 PM", sat: "09:30 AM - 3:30 PM", sun: "Closed" },
      ...
      },
      {
        name: "Axis Bank",
        branch: "New Barrackpore",
        address: "Ground Floor, 38/1/1, Barasat Rd, Nona Chandanpukur, Jaffarpukur, Barrackpore, West Bengal 700122",
        ifsc: "UTIB0002555",
        phone: "18605005555",
        hours: { mon_fri: "09:30 AM - 3:30 PM", sat: "09:30 AM - 3:30 PM", sun: "Closed" },
      ...
      },
      {
        ...
        branch: "Barrackpore",
        address: "25 26 And 28 S.n.banerjee Road, Chiriarmore, Barrackpore, North.24 Paraganas, West Bengal 743101",
        ifsc: "CBIN0281090",
        phone: "03325920553",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        name: "Hdfc Bank",
        branch: "Nona Chandanpukur",
        address: "No 37/2, Gr Floor, Biswanath Residency, Barasat Rd, Nona Chandanpukur, Jaffarpur More, Kolkata, Barrackpore, West Bengal 700122",
        ifsc: "HDFC0007229",
        phone: "9409767967",
        hours: { mon_fri: "09:30 AM - 3:30 PM", sat: "09:30 AM - 3:30 PM", sun: "Closed" },
      ...
      },
      {
        name: "Hdfc Bank",
        branch: "Barrackpore",
        address: "No 5, BT Road Barrackpore North 24 Parganas, West Bengal - 700120",
        ifsc: "HDFC0007800",
        phone: "9409767967",
        hours: { mon_fri: "09:30 AM - 3:30 PM", sat: "09:30 AM - 3:30 PM", sun: "Closed" },
      ...
      },
      {
        name: "Bank Of Baroda",
        branch: "Barrackpore",
        address: "1/A Middle Road Anandpuri Po:, Nona Chandanpukur, New, Barrackpore, West Bengal 700122",
        ifsc: "BARB0BARRAC",
        phone: "221800223344",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        name: "Bank Of Baroda",
        branch: "Nona Chandanpukur",
        address: "Ward No.05, 37(79/1, Barasat Rd, Nona Chandanpukur, Barrackpore, West Bengal 700122",
        ifsc: "BARB0DBBPOR",
        phone: "221800223344",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        name: "Bank Of Baroda",
        branch: "Jaffarpur",
        address: "37(79/1)barasat Road Jaffarpur More Ward No 5 Nona Chandanpukur Barrackpore 700122",
        ifsc: "BARB0VJBAPO",
        phone: "221800223344",
        hours: { mon_fri: "10:00 AM - 4:00 PM", sat: "10:00 AM - 4:00 PM", sun: "Closed" },
      ...
      },
      {
        ...
        address: "ICICI Bank Ltd., 4(2), S. N. Banerjee Road, Barrackpore, Kolkata,North 24 Parganas Dist, - 700120",
        ifsc: "ICIC0003306",
        phone: "18001080",
        hours: { mon_fri: "9:30 AM - 3:00 PM", sat: "9:30 AM - 3:00 PM", sun: "Closed" },
    ...
    function placeBankMarkers(banksToShow) {
      ...
      if (banksToShow.length > 0) {
        ...
        banksToShow.forEach((bank) =>
          bounds.extend(new google.maps.LatLng(bank.coordinates[0], bank.coordinates[1]))
        );
    ...
    function displayBankCards(banksToShow) {
      ...
      banksToShow.forEach((bank) => {
        ...
        html += `<div class="bank-card">
          ...
          <p><strong>Status:</strong> <span class="${isOpen ? "status-open" : "status-closed"}">
    ...
    function findNearbyBanks() {
      ...
      if (userPosition) {
        ...
        banksToShow = banks
          .filter((bank) => {
            const d = parseFloat(
              calculateDistance(userPosition.lat, userPosition.lng, bank.coordinates[0], bank.coordinates[1])
            );
            return d <= radiusKm;
          })
          .sort((a, b) => {
            const da = parseFloat(calculateDistance(userPosition.lat, userPosition.lng, a.coordinates[0], a.coordinates[1]));
            const db = parseFloat(calculateDistance(userPosition.lat, userPosition.lng, b.coordinates[0], b.coordinates[1]));
            return da - db;
          });
      }
